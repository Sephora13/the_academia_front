...
@Component({
  selector: 'app-dashboard-exam-service',
  imports: [FormsModule, CommonModule],
  templateUrl: './dashboard-exam-service.component.html',
  styleUrl: './dashboard-exam-service.component.css'
})
export class DashboardExamServiceComponent {
  activeLink: string = '';
